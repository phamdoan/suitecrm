...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'HR Grades Danh sách',
  'LBL_MODULE_NAME' => 'HR Grades',
  'LBL_MODULE_TITLE' => 'HR Grades',
  'LBL_HOMEPAGE_TITLE' => 'Của tôi HR Grades',
  'LNK_NEW_RECORD' => 'Tạo HR Grades',
  'LNK_LIST' => 'Xem HR Grades',
  'LNK_IMPORT_HRCOR_HR_GRADES' => 'Import HR Grades',
  'LBL_SEARCH_FORM_TITLE' => 'Tìm kiếm HR Grades',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Xem lịch sử',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Hoạt động',
  'LBL_HRCOR_HR_GRADES_SUBPANEL_TITLE' => 'HR Grades',
  'LBL_NEW_FORM_TITLE' => 'Mới HR Grades',
  'LBL_BASE_SALARY' => 'Base Salary (Lương cơ bản)',
  'LBL_KPI_SALARY' => 'KPI Salary (Lương KPI)',
  'LBL_COMMISSION_RATE' => 'Commission Rate % (Tỉ lệ hoa hồng %)',
  'LBL_SI_RATE' => 'SI Rate % (BHXH %)',
  'LBL_NOTES' => 'Notes',
);