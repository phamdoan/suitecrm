...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'trước',
// Activity stream
    'CREATED_CONTACT' => 'tạo một <b>NEW</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'tạo một <b>NEW</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'tạo một <b>NEW</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'tạo một <b>NEW</b> {0}', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
